                   ...
                   <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">List of Sub-Topic</div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                   <div class="table-toolbar">
                                      ...
                                      <div class="btn-group">
                                         <a href="add-sub.php"><button class="btn btn-success">Add New <i class="icon-plus icon-white"></i></button></a>
                                      </div>
                                    ...
                                    <tbody>
                                        ...
                                        while($row=mysql_fetch_array($run)){
                                            ...
                                            <li><a href="edit-sub.php?sub_Id='.$row["sub_Id"].'"><span class="glyphicon glyphicon-edit"></span> Edit</a></li>
                                            <li><a href="#"  sub_Id="'.$row['sub_Id'].'" class="delbutton" title="Click To Delete"><span class="glyphicon glyphicon-trash"></span> Delete</a></li>
                                            </ul>
                                            </div>'
                                                    ."</td>";
...
var del_id = element.attr("sub_Id");

//Built a url to send
var info = 'sub_Id=' + del_id;
