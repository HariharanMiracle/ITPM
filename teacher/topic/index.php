                   ...
                   <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                ...
                                <a href="sub_topic.php"><span class="glyphicon glyphicon-plus-sign"></span>Sub-Topics</a>
                                   ...
                                   <div class="table-toolbar">
                                    ...
                                    <tbody>
                                        ...
                                        while($row=mysql_fetch_array($run)){
                                            ...
                                            <li><a href="edit.php?topic_Id='.$row["topic_Id"].'"><span class="glyphicon glyphicon-edit"></span> Edit</a></li>
                                            <li><a href="#"  topic_Id="'.$row['topic_Id'].'" class="delbutton" title="Click To Delete"><span class="glyphicon glyphicon-trash"></span> Delete</a></li>
                                            </ul>
                                            </div>'
                                                    ."</td>";
