                             ...
                             $id = $_GET['user_Id'];
                                ...
                                extract($_POST);
                                    ...
                                    if(isset($edit))
                                    {
                                        ...
                                        $sql = "UPDATE `tbl_user` SET `fname`='$fname',`mname`='$mname',`lname`='$lname',`dob`='$dob',`gender`='$gender',`course`='$course',`yrlvl`='$yrlvl',`username`='$username',`$password`='$password' WHERE `user_Id`='$id'";
                                        $run = mysql_query($sql);
