	...
	<body>
		<div class="container">			
			<div class="page-header">
				<h1><small>Upload Assignments</small> </h1><br><br><br><br>
			</div>
				...
				<div class="panel-body">
					<form method="post" enctype="multipart/form-data" name="formUploadFile" id="uploadForm" action="upload.php">
						<div class="form-group">
							...
							<p class="help-block"><span class="label label-info">Note:</span> Please, Select  (.jpg, .jpeg, .png, .gif,.doc) to upload with the size of 100KB only.</p>
						</div>			
